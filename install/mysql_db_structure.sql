...
CREATE TABLE tce_sessions (cpsession_id Varchar(32) NOT NULL,
																												...
																												Primary Key (cpsession_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_users (user_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE tce_modules (module_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																											module_name Varchar(255) NOT NULL,
																											module_enabled Bool NOT NULL DEFAULT '0',
																											module_user_id Bigint UNSIGNED NOT NULL DEFAULT 1,
																											Primary Key (module_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_subjects (subject_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																												subject_module_id Bigint UNSIGNED NOT NULL DEFAULT 1,
																												subject_name Varchar(255) NOT NULL,
																												subject_description Text, subject_enabled Bool NOT NULL DEFAULT '0',
																												subject_user_id Bigint UNSIGNED NOT NULL DEFAULT 1,
																												Primary Key (subject_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_questions (question_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																													...
																													Primary Key (question_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_answers (answer_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																											...
																											Primary Key (answer_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_tests (test_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																									...
																									Primary Key (test_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_test_subjects (subjset_tsubset_id Bigint UNSIGNED NOT NULL,
																																	subjset_subject_id Bigint UNSIGNED NOT NULL,
																																	Primary Key (subjset_tsubset_id,
																																															subjset_subject_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_tests_users (testuser_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																															...
																															testuser_comment Text, Primary Key (testuser_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_tests_logs (testlog_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																														testlog_testuser_id Bigint UNSIGNED NOT NULL,
																														testlog_user_ip Varchar(39),
																														testlog_question_id Bigint UNSIGNED NOT NULL,
																														testlog_answer_text Text, testlog_score Decimal(10,3),
																														...
																														testlog_comment Text, Primary Key (testlog_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_tests_logs_answers (logansw_testlog_id Bigint UNSIGNED NOT NULL,
																																						...
																																						Primary Key (logansw_testlog_id,
																																																				logansw_answer_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_user_groups (group_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																															group_name Varchar(255) NOT NULL,
																															UNIQUE (group_name), Primary Key (group_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_usrgroups (usrgrp_user_id Bigint UNSIGNED NOT NULL,
																													usrgrp_group_id Bigint UNSIGNED NOT NULL,
																													Primary Key (usrgrp_user_id,
																																											usrgrp_group_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_testgroups (tstgrp_test_id Bigint UNSIGNED NOT NULL,
																														tstgrp_group_id Bigint UNSIGNED NOT NULL,
																														Primary Key (tstgrp_test_id,
																																												tstgrp_group_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_test_subject_set (tsubset_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																																				...
																																				Primary Key (tsubset_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_sslcerts (ssl_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
																												...
																												Primary Key (ssl_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_testsslcerts (tstssl_test_id BIGINT UNSIGNED NOT NULL,
																																tstssl_ssl_id BIGINT UNSIGNED NOT NULL,
																																Primary Key (tstssl_test_id,
																																														tstssl_ssl_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_testuser_stat (tus_id Bigint UNSIGNED NOT NULL AUTO_INCREMENT,
																																	tus_date Datetime NOT NULL,
																																	PRIMARY KEY (tus_id)) ENGINE = InnoDB CHARACTER
SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE tce_users ADD UNIQUE ak_user_email (user_email);
...
ALTER TABLE tce_tests_logs_answers ADD
...
ALTER TABLE tce_testgroups ADD
Foreign Key (tstgrp_test_id) references tce_tests (test_id) ON
DELETE cascade ON
UPDATE no action;


ALTER TABLE tce_test_subject_set ADD
...
ALTER TABLE tce_testsslcerts ADD
